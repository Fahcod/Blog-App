...
const Login = () => {
  ...
  const submitData = async () =>{
    let response=await axiosInstance.post('/api/v1/user/login',formData);
  ...
  return (
    ...
    <div>
      <h2 className="font-[Rubik-Bold] text-xl py-3 text-center">Login to Blogspot</h2>
    </div>
    {/* the fields */}
    ...
    <div>
      <p className="text-[#333]">Don't have an account?<Link to="/signup">Signup</Link></p>
    </div>
